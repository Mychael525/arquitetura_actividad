...
from machine import Pin, ADC, PWM # Importar la clase ADC para leer el potenciómetro
...
while True:
    ...
    # Mapea el valor del potenciómetro a un valor de tiempo de espera (de 0.01 a 0.1 segundos)
    delay_time = 0.01 + (pot_value / 1023.0) * 0.1  # Tiempo de espera entre 0.01 y 0.1 segundos
